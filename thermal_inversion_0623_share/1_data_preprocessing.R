...
wind_air_out_idx= read.csv("wind_air_out_idx.csv")
...
### 일평균 ###
wind_2013 <- read.csv("wind_2013_dec.csv")
...
wind_2014 <- read.csv("wind_2014.csv")#9.12~9.14 결측
...
wind_2015 <- read.csv("wind_2015.csv")
...
wind_2016 <- read.csv("wind_2016.csv")
...
wind_2017 <- read.csv("wind_2017.csv")
